...
ReactDOM.render(
	<BrowserRouter>
		<Switch>
			<Route path="/stages/40" component={Stage40} />
			<Route path="/stages/39" component={Stage39} />
			<Route path="/stages/38" component={Stage38} />
			<Route path="/stages/37" component={Stage37} />
			<Route path="/stages/36" component={Stage36} />
			<Route path="/stages/35" component={Stage35} />
			<Route path="/stages/34" component={Stage34} />
			<Route path="/stages/33" component={Stage33} />
			<Route path="/stages/32" component={Stage32} />
			<Route path="/stages/31" component={Stage31} />
			<Route path="/stages/30" component={Stage30} />
			<Route path="/stages/29" component={Stage29} />
			<Route path="/stages/28" component={Stage28} />
			<Route path="/stages/27" component={Stage27} />
			<Route path="/stages/26" component={Stage26} />
			<Route path="/stages/25" component={Stage25} />
			<Route path="/stages/24" component={Stage24} />
			<Route path="/stages/23" component={Stage23} />
			<Route path="/stages/22" component={Stage22} />
			<Route path="/stages/21" component={Stage21} />
			<Route path="/stages/20" component={Stage20} />
			<Route path="/stages/19" component={Stage19} />
			<Route path="/stages/18" component={Stage18} />
			<Route path="/stages/17" component={Stage17} />
			<Route path="/stages/16" component={Stage16} />
			<Route path="/stages/15" component={Stage15} />
			<Route path="/stages/14" component={Stage14} />
			<Route path="/stages/13" component={Stage13} />
			<Route path="/stages/12" component={Stage12} />
			<Route path="/stages/11" component={Stage11} />
			<Route path="/stages/10" component={Stage10} />
			<Route path="/stages/09" component={Stage09} />
			<Route path="/stages/08" component={Stage08} />
			<Route path="/stages/07" component={Stage07} />
			<Route path="/stages/06" component={Stage06} />
			<Route path="/stages/05" component={Stage05} />
			<Route path="/stages/04" component={Stage04} />
			<Route path="/stages/03" component={Stage03} />
			<Route path="/stages/02" component={Stage02} />
			<Route path="/stages/01" component={Stage01} />
