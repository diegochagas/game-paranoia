		...
		<div className="App-game">
			...
			<section className="game">
				...
				<div className="game-stage">
			        ...
			        <Link className="btn-game" to="/stages/13">Quer entrar e pegar a chave? Vá para 13.</Link>
			        <Link className="btn-game" to="/stages/31">Quer ficar esperando um milagre? Vá para 31.</Link>
				</div>
			</section>
			<Footer/>
		</div>
