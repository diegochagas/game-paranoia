		...
		<div className="App-game">
			...
			<section className="game">
				...
				<div className="game-stage">
			        ...
			        <Link className="btn-game" to="/stages/37">Se quiser contar, vá para 37</Link>
			        <Link className="btn-game" to="/stages/11">Se achar melhor ficar quieto vá para 11.</Link>
			    </div>
	    	</section>
	        <Footer/>
		</div>
