		...
		<div className="App-game">
			...
			<section className="game">
				...
				<div className="game-stage">
			        ...
			        <Link className="btn-game" to="/stages/07">"Senhor, preciso pegar um objeto que está no lixo daquele robô. Você poderia trazer o robô até mim"? Vá para 7.</Link>
			        <Link className="btn-game" to="/stages/28">"Cidadão, o sábio computador me mandou verificar em todos os lixos se havia chaves ALF. Como aquele robô está em uma área vermelha, onde não posso entrar, você ficaria muito feliz em ajudar o Computador verificando por mim, não é"? Vá para 28.</Link>     
				</div>
			</section>
			<Footer/>
		</div>
